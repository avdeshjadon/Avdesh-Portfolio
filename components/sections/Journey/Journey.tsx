...
const CHAPTERS: Chapter[] = [
  {
    ...
    title: (
      <>
        I&rsquo;m Avdesh — I build software people{" "}
        <em className={styles.serif}>trust.</em>
      </>
    ),
    body: "Full Stack Developer & Software Tester, currently building and testing Heeding Climate Solutions' sustainable-fuel marketplace while completing my MSc at Montpellier Business School.",
  },
  {
    label: "My Journey",
    title: (
      <>
        I came to development from the{" "}
  ...
  },
  {
    ...
    title: (
      <>
        Code earns attention. Clarity earns{" "}
        <em className={`${styles.serif} ${styles.red}`}>trust.</em>
      </>
    ),
    body: "Outcomes earn the next project. Tests first, metrics always · prototype early, decide with evidence · systems over screens · ship the story.",
  },
  {
    label: "Business × Engineering",
    title: (
      <>
        Every feature has a job — and a{" "}
        <em className={styles.serif}>KPI.</em>
      </>
    ),
    body: "My business background is the engineer's edge: I build toward measurable outcomes, from conversion intent to $70K+ in revenue generated by the work.",
  },
  {
    ...
    body: "AI accelerates my research, iteration and build speed — the judgement, taste and empathy stay human.",
  },
  {
    label: "My Process",
    title: (
      <>
        Spec → build →{" "}
        <em className={styles.serif}>test</em> → ship.
      </>
    ),
    body: "I map the problem with real users, prototype before committing, ship in small slices and let CI, tests and measured behaviour — not opinions — pick the winner.",
  },
  {
    label: "Vision",
    title: (
